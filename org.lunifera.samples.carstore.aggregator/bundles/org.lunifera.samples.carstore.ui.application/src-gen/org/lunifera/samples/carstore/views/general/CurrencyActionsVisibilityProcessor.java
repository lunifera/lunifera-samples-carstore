...
public class CurrencyActionsVisibilityProcessor implements IVisibilityProcessor {
  ...
  public void init(final IVisibilityManager manager) {
    ...
    mainLayout = manager.getById("CurrencyDetails.Detail");
  }
  ...
  public CurrencyDto getMain() {
    return this.main;
  }
  
  public void setMain(final CurrencyDto main) {
    this.main=main;
