...
public class WeightDto implements IDto, Serializable, PropertyChangeListener {
  ...
  public WeightDto copy(final MappingContext context) {
    checkDisposed();
    ...
    // then return it
    WeightDto newDto = context.get(this);
    if(newDto != null){
    	return newDto;
    }
  ...
  public void copyContainments(final WeightDto dto, final WeightDto newDto, final MappingContext context) {
    checkDisposed();
  ...
  public void copyCrossReferences(final WeightDto dto, final WeightDto newDto, final org.lunifera.dsl.dto.lib.MappingContext context) {
    checkDisposed();
