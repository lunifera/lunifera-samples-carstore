...
public class LengthDto implements IDto, Serializable, PropertyChangeListener {
  ...
  @DomainReference
  @TargetEnumConstraints(constraints = @TargetEnumConstraint(targetProperty = "family", enumClass = UOMFamily.class, enumLiteral = "LENGTH"))
  ...
  public LengthDto copy(final MappingContext context) {
    checkDisposed();
    ...
    // then return it
    LengthDto newDto = context.get(this);
    if(newDto != null){
    	return newDto;
    }
  ...
  public void copyContainments(final LengthDto dto, final LengthDto newDto, final MappingContext context) {
    checkDisposed();
  ...
  public void copyCrossReferences(final LengthDto dto, final LengthDto newDto, final org.lunifera.dsl.dto.lib.MappingContext context) {
    checkDisposed();
