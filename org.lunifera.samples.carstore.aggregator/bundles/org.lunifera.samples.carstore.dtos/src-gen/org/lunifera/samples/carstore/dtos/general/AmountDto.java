...
public class AmountDto implements IDto, Serializable, PropertyChangeListener {
  ...
  public AmountDto copy(final MappingContext context) {
    checkDisposed();
    ...
    // then return it
    AmountDto newDto = context.get(this);
    if(newDto != null){
    	return newDto;
    }
  ...
  public void copyContainments(final AmountDto dto, final AmountDto newDto, final MappingContext context) {
    checkDisposed();
  ...
  public void copyCrossReferences(final AmountDto dto, final AmountDto newDto, final org.lunifera.dsl.dto.lib.MappingContext context) {
    checkDisposed();
