...
public class CarManufacturerDto extends BaseDto implements IDto, Serializable, PropertyChangeListener {
  ...
  public CarManufacturerDto copy(final MappingContext context) {
    checkDisposed();
    ...
    // then return it
    CarManufacturerDto newDto = context.get(this);
    if(newDto != null){
    	return newDto;
    }
  ...
  public void copyContainments(final CarManufacturerDto dto, final CarManufacturerDto newDto, final MappingContext context) {
    checkDisposed();
  ...
  public void copyCrossReferences(final CarManufacturerDto dto, final CarManufacturerDto newDto, final org.lunifera.dsl.dto.lib.MappingContext context) {
    checkDisposed();
