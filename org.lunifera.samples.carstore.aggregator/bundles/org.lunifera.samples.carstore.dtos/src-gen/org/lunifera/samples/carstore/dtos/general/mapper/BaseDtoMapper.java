...
public class BaseDtoMapper<DTO extends BaseDto, ENTITY extends Base> implements IMapper<DTO, ENTITY> {
   ...
   * 
   */
  protected String toDto_id(final Base in, final MappingContext context) {
    return in.getId();
  }
   ...
   * 
   */
  protected String toEntity_id(final BaseDto in, final MappingContext context) {
    return in.getId();
  }
  
  public String createDtoHash(final Object in) {
    return org.lunifera.runtime.common.hash.HashUtil.createObjectWithIdHash(BaseDto.class, in);
  }
  
  public String createEntityHash(final Object in) {
    return org.lunifera.runtime.common.hash.HashUtil.createObjectWithIdHash(Base.class, in);
  }
}
