...
public class PriceDto implements IDto, Serializable, PropertyChangeListener {
  ...
  public PriceDto copy(final MappingContext context) {
    checkDisposed();
    ...
    // then return it
    PriceDto newDto = context.get(this);
    if(newDto != null){
    	return newDto;
    }
  ...
  public void copyContainments(final PriceDto dto, final PriceDto newDto, final MappingContext context) {
    checkDisposed();
  ...
  public void copyCrossReferences(final PriceDto dto, final PriceDto newDto, final org.lunifera.dsl.dto.lib.MappingContext context) {
    checkDisposed();
    ...
    // copy dto currency
    if(getCurrency() != null) {
    	newDto.setCurrency(getCurrency().copy(context));
    }
  }
