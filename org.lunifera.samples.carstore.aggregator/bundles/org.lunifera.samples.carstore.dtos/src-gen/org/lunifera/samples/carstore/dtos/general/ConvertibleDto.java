...
public class ConvertibleDto extends CarDto implements IDto, Serializable, PropertyChangeListener {
  ...
  public ConvertibleDto copy(final MappingContext context) {
    checkDisposed();
    ...
    // then return it
    ConvertibleDto newDto = context.get(this);
    if(newDto != null){
    	return newDto;
    }
  ...
  public void copyContainments(final ConvertibleDto dto, final ConvertibleDto newDto, final MappingContext context) {
    checkDisposed();
    ...
    // copy roofType
    newDto.setRoofType(getRoofType());
    // copy color
  ...
  public void copyCrossReferences(final ConvertibleDto dto, final ConvertibleDto newDto, final org.lunifera.dsl.dto.lib.MappingContext context) {
    checkDisposed();
